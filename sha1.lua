...
local function hmac_sha1_string(key, text)
...
function hmac_sha1_message(s)
	return hmac_sha1_string(sha1key, s)
end

function hmac_sha1_message_verify(text, in_signature)
	local signature = hmac_sha1_message(text)
--print ('#####################',signature, in_signature)
	if not in_signature or in_signature=='n/a' or in_signature=='' then
		return 'missing'
	end
	if signature==in_signature then
		return 'ok'
	else
		return 'fail'
	end
